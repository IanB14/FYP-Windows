...
namespace App5
{
    ...
    public sealed partial class pharmacies : Page
    {
        ...
        public pharmacies()
        {
            ...
            // Variable to hold the current amount of pharmacies - set to 1 by default
            int pharmacyCount = 1;


            // If addPharmacies is called, increase the pharmacy counter by 1 - this allows the count to be the name of the mapIcon
